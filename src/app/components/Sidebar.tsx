        ...
        <SheetContent side="left" className="w-64 border-r bg-white p-0">
          ...
          <ScrollArea className="h-[calc(100vh-56px)] px-4 py-6">
            <nav className="space-y-2">
              <SheetClose asChild>
                <Link href="/dashboard" className="block rounded-md px-3 py-2 hover:bg-accent/50 transition">
                  Dashboard
                </Link>
              </SheetClose>
              <SheetClose asChild>
                <Link href="/roles" className="block rounded-md px-3 py-2 hover:bg-accent/50 transition">
                  Roles y permisos
                </Link>
              </SheetClose>
              {/* … más enlaces … */}
